...
public class CreateOrganizationWithIndustryAndType
{
	...
	public static void main(String[] args) 
	{
		...
		driver.findElement(By.name("accountname")).sendKeys("Montesseri");
		...
		WebElement typeDropdoen = driver.findElement(By.name("accounttype"));
		Select type= new Select(typeDropdoen);
		...
		if (headerText.contains("Montesseri"))
		{
